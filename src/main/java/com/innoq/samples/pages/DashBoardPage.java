...
public class DashBoardPage extends BasePage {
    ...
    public DashBoardPage() {
        ...
        IModel<List<Appointment>> apmtModel = async(new AppointmentModel(user));
        IModel<List<Project>> projectsModel = async(new ProjectsModel(user));
        IModel<FinancialStatus> fnStatModel = async(new FinancialStatusModel(user));
